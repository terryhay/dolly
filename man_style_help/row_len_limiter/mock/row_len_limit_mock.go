...
func GetRowLenLimit(w size.Width) rll.RowLenLimit {
	...
	return limiter.RowLenLimit(w)
}

// GetRowLenLimitMin returns minimum RowLenLimit object value
// which row_len_limiter.RowLenLimiter.RowLenLimit method can get
...
// which row_len_limiter.RowLenLimiter.RowLenLimit method creates if terminal width value is 25
